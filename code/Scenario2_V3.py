...
class Main():
    ...
    if choice == "1":
        ...
        with open('Meter_To_Feet.txt', 'w') as f:
            sys.stdout = f
            print("Value in Feet is ", ans_1)
    ...
    if choice == "2":
        ...
        with open('Feet To Meters.txt', 'w') as f:
            sys.stdout = f
            print("Value in Meters is ", ans_2)
    ...
    if choice == "3":
        ...
        print(ans_3)
        original_stdout1 = sys.stdout
        with open('Centimeter_To_Inches.txt', 'w') as f:
            sys.stdout = f
